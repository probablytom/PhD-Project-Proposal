...
\begin{abstract}
Sociotechnical systems research --- which can cover everything from workflow modelling, to analysing responsibility, to modelling the nature of human-like concepts like Trust --- can be deep and often powerful, but sees too little application in the real world. We seek to apply an analysis of trust, an active topic of research, to network security to create new and novel security techniques.
\end{abstract}
...
Computational Trust, and its relation to security, combine to make an especially deep subject of study which can often be neglected as a security measure in practice. There are good reasons why this might be: sociotechnical systems research can be difficult, and these systems themselves can be notoriously complex in practice.\cite{Crabtree2000} Many trust models exists, however, and are getting more detailed and expressive as time wears on.\par

We see this as a wasted opportunity. Computational Trust models allow a software systems to intelligently assess the safety and security of a system when faced with any situation. As such, it can allow for security systems which can grow in depth and complexity massively while remaining useable; strong security would only be presented in an uncomfortable, unfamiliar situation for an AI which "guards" some secure network or software system.\sidenote{One can imagine constructing a computer system which governs its own security, allowing humans it knows and trusts to pass rigorous but less frustrating security tests for the user. This would permit a very high degree of security while minimising the error humans introduce when faced with security challenges they perceive as "difficult", like remembering complex passwords.} \par
...
As an example of the possible outcome of the work, a network monitoring artificial agent could be produced which analyses network security threats, categorised by origin and predicted intent, and filters trustworthy and untrustworthy sources such that appropriate security measures can be put in place. This agent could also flag potentially untrustworthy activity, allowing human agents to assess its judgements and gain critical insights into security probing and oncoming security threats.\par

This agent could take advantage of the slew of approaches to computational trust, as well as advancing the field's theoretical boundaries by providing a real-world application to test future models of trust against. For example, modal logic approaches by Kramdi in 2015\cite{Kramdi} or social trust analysis from Urbano, Rocha and Oliveira in 2014\cite{Urbano2014}.\par

\section{My Suitability}
My own interest in sociotechnical systems comes from a long-held interest in them. In 2015 and 2016 I completed my honours project, a workflow modelling system which used my own novel approach to program mutation to simulate human error in a sociotechnical model. For this, I won the 2016 Best Software Product prize for my year.\sidenote{A paper on the work is currently being written, alongside my project supervisor, Tim Storer.}\par

Having found sociotechnical systems to be a field with many questions to be answered, I am now pursuing an MSci, for which my project is an adaptation of Trust models to create a model of computational responsibility. In doing this, I have grown an appreciation of the breadth and nuances of various models of trust, and look to employ this knowledge in PhD research.\par

Aside from sociotechnical modelling, I am a part-time Python and project management consultant for a fintech startup in London\sidenote{This particular consulting contract follows my internship work for them doing software engineering this summer.}. I believe that my proven understanding of software engineering, strong familiarity with various aspects of sociotechnical systems modelling, and a genuine fascination for applications of sociotechnical research make me an ideal PhD candidate.
